...
Scenario Outline: Unsuccessful password modification
    ...
    When the user "User1" with password "userpassword1" is logged into their account
	And the user inputs the old password "<oldpassword>", inputs the new password "<newpassword>" and confirms the new password "<newpasswordconfirm>"
  ...
  Examples:
	  ...
	  | userpassword1 | userpassword2 |                    | PASSWORD-CHANGE-CONFIRM-EMPTY    |
